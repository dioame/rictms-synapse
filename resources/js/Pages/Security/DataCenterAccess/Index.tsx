...
const config = {
    ...
    route: 'security.data-center-access'
}
...
export default function Index({ auth }: any) {
  ...
  {
      key: "duration_of_visit",
      label: "Duration of Visit",
      className: "hidden sm:table-cell text-center",
  },
  {
      key: "proof_of_identity_presented",
      label: "Proof of Identity Presented",
      className: "hidden sm:table-cell text-center",
  },
    {
      key: "actions",
      ...
      render: (value: any) => (
        <RowActions
          ...
          actions={[
            ...
            {
              label: "Print Form",
              href: route(`${config.route}.form`,{id:value.id})
            },
            {
              label: "Edit",
